...
<head>
  ...
  <meta property="og:image" content="{{asset('../../../s3.amazonaws.com/creativetim_bucket/products/51/original/opt_mdp_thumbnail.jpg')}}" />
...
<body class="">
  ...
  <div class="wrapper ">
    <div class="sidebar" data-color="rose" data-background-color="black" data-image="{{asset('../assets/img/sidebar-1.jpg')}}">
      ...
      <div class="sidebar-wrapper">
        <div class="user">
          <div class="photo">
            <img src="{{asset('../assets/img/rynan.png')}}" />
          </div>
          <div class="user-info">
        ...
        <ul class="nav">
          ...
          <li class="nav-item ">
            ...
            <div class="collapse" id="pagesExamples">
              <ul class="nav">
                <li class="nav-item ">
                  <a class="nav-link" href="{{asset('admin/account/list.html')}}">
                    <span class="sidebar-mini"> TK </span>
                    <span class="sidebar-normal"> Tài Khoản </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="{{asset('admin/room/list.html')}}">
                    <span class="sidebar-mini"> PB </span>
                    <span class="sidebar-normal">Phòng Ban </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="{{asset('admin/reason/list.html')}}">
                    <span class="sidebar-mini"> LD </span>
                    <span class="sidebar-normal"> Lý Do Phép</span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="{{asset('admin/staff/list.html')}}">
                    <span class="sidebar-mini"> NV </span>
                    <span class="sidebar-normal">Nhân Viên</span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="{{asset('admin/preoff/list.html')}}">
                    <span class="sidebar-mini"> NP </span>
                    <span class="sidebar-normal"> Nghỉ Phép </span>
                  </a>
                </li>
                <!-- <li class="nav-item ">
              ...
              <ul class="nav">
                <!-- <li class="nav-item ">
                  <a class="nav-link" data-toggle="collapse" href="#componentsCollapse">
                    ...
                    <span class="sidebar-normal"> Danh Sách
                      <b class="caret"></b>
                    </span>
                  </a>
                    ...
                    <ul class="nav">
                      <li class="nav-item ">
                        <a class="nav-link" href="#0">
                          <span class="sidebar-mini"> E </span>
                          <span class="sidebar-normal"> Báo Cáo </span>
                        </a>
                      </li>
                    </ul>
                  </div>
                ...
                <li class="nav-item ">
                  <a class="nav-link" href="{{asset('admin/checking/list.html')}}">
                    <span class="sidebar-mini"> DS </span>
                    <span class="sidebar-normal"> Danh Sách </span>
                  </a>
                </li>
                <li class="nav-item ">
                  <a class="nav-link" href="{{asset('admin/report/list.html')}}">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">@yield('title2')</a>
          </div>
    ...
    <div class="dropdown show-dropdown">
      ...
      <ul class="dropdown-menu">
        ...
        <li class="button-container github-star">
          <a class="github-button"  data-icon="octicon-star" data-size="large" data-show-count="true" aria-label="Star ntkme/github-buttons on GitHub">Star</a>
        </li>
  ...
  <script src="{{asset('https://cdnjs.cloudflare.com/ajax/libs/core-js/3.21.1/minified.js')}}"></script>
