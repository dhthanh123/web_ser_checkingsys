      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-8 ml-auto mr-auto">
            <form class="form" method="post" action="/login.html" enctype="multipart/form-data">
              @csrf {{ csrf_field() }}
              <div class="card card-login card-hidden">
                ...
                <div class="card-body ">
                  ...
                  <div class="input-group">
                    ...
                    <input type="text" name="us_name" class="form-control" placeholder="Tên đăng nhập..">
                  </div>
                </span>
                <span class="bmd-form-group">
                    <div class="input-group">
                      ...
                      <input type="password" name="us_pass" class="form-control" placeholder="Mật khẩu...">
                    </div>
                  </span>
                </div>
                <div class="card-footer justify-content-center">
                  <button type="submit" name="button" class="btn btn-rose btn-link btn-lg">Đăng nhập</button>
                </div>
              </div>
            </form>
          </div>
